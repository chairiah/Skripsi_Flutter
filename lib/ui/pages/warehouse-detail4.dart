...
class WarehouseDetailPage4 extends StatelessWidget {
  const WarehouseDetailPage4({Key? key}) : super(key: key);
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              _launchUrl(Uri.parse(
                                  'https://goo.gl/maps/TS32XJWnE8eqRD2t8'));
                            },
                            child: Text(
                              'Jl. Simpang Empat, Takengon, Aceh Tengah',
                              style: brownTextStyle.copyWith(
                                fontSize: 13,
                                fontWeight: bold,
                              ),
                          ...
                          const SocialButton(
                            url: 'tel:6282237836435',
                            content: '082237836435',
                            isWhatsApp: true,
                          ),
                        ],
                      ),
